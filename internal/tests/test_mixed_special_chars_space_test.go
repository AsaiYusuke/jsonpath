...
func TestSpecialChars_InvalidTabCharacters(t *testing.T) {
	testCase := TestCase{
		jsonpath:    "\t" + `$.a` + "\t",
		inputJSON:   `{"a":123}`,
		expectedErr: createErrorInvalidSyntax(0, `unrecognized input`, "\t"+`$.a`+"\t"),
	}
...
func TestSpecialChars_TabCharacterInvalid(t *testing.T) {
	testCase := TestCase{
		jsonpath:    `$.` + "\x09",
		inputJSON:   `{"\t":1}`,
		expectedErr: createErrorInvalidSyntax(1, `unrecognized input`, `.`+"\x09"),
	}
...
func TestSpecialChars_CrCharacterInvalid(t *testing.T) {
	testCase := TestCase{
		jsonpath:    `$.` + "\x0d",
		inputJSON:   `{"\n":1}`,
		expectedErr: createErrorInvalidSyntax(1, `unrecognized input`, `.`+"\x0d"),
	}
...
func TestSpecialChars_ControlCharacter1fInvalid(t *testing.T) {
	testCase := TestCase{
		jsonpath:    `$.` + "\x1f",
		inputJSON:   `{"a":1}`,
		expectedErr: createErrorInvalidSyntax(1, `unrecognized input`, `.`+"\x1f"),
	}
...
func TestSpecialChars_DelCharacterInvalid(t *testing.T) {
	testCase := TestCase{
		jsonpath:    `$.` + "\x7F",
		inputJSON:   `{"` + "\x7F" + `":1}`,
		expectedErr: createErrorInvalidSyntax(1, `unrecognized input`, `.`+"\x7F"),
	}
...
func TestSpecialChars_PropertyWithDelCharacterInvalid(t *testing.T) {
	testCase := TestCase{
		jsonpath:    `$.a` + "\x7F",
		inputJSON:   `{"a` + "\x7F" + `":1}`,
		expectedErr: createErrorInvalidSyntax(3, `unrecognized input`, "\x7F"),
	}
