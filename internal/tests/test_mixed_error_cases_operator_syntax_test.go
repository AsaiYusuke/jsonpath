...
func TestRetrieve_invalid_literal_false_filter_error(t *testing.T) {
	testCase := TestCase{
		...
		expectedErr: createErrorInvalidSyntax(1, `unrecognized input`, `[?(false)]`),
	}
...
func TestRetrieve_invalid_literal_true_filter_error(t *testing.T) {
	testCase := TestCase{
		jsonpath:    `$[?(true)]`,
		inputJSON:   `[0,1,false,true,null,{},[]]`,
		expectedErr: createErrorInvalidSyntax(1, `unrecognized input`, `[?(true)]`),
	}
...
func TestRetrieve_invalid_literal_null_filter_error(t *testing.T) {
	testCase := TestCase{
		jsonpath:    `$[?(null)]`,
		inputJSON:   `[0,1,false,true,null,{},[]]`,
		expectedErr: createErrorInvalidSyntax(1, `unrecognized input`, `[?(null)]`),
	}
...
func TestRetrieve_invalid_slice_comparison_error(t *testing.T) {
	testCase := TestCase{
		...
		expectedErr: createErrorInvalidSyntax(1, `unrecognized input`, `[?(@[0:1]==[1])]`),
	}
...
func TestRetrieve_invalid_object_comparison_error(t *testing.T) {
	testCase := TestCase{
		jsonpath:    `$[?(@=={"k":"v"})]`,
		inputJSON:   `{}`,
		expectedErr: createErrorInvalidSyntax(1, `unrecognized input`, `[?(@=={"k":"v"})]`),
	}
