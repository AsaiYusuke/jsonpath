...
func TestBracketNotation_WildcardSimple(t *testing.T) {
	...
	runTestCases(t, "TestBracketNotation_WildcardSimple", tests)
}
...
func TestBracketNotation_WildcardComplexCombinations(t *testing.T) {
	...
	runTestCases(t, "TestBracketNotation_WildcardComplexCombinations", tests)
}
...
func TestBracketNotation_WildcardArraySlice(t *testing.T) {
	...
	runTestCases(t, "TestBracketNotation_WildcardArraySlice", tests)
}
...
func TestBracketNotation_WildcardNestedAccess(t *testing.T) {
	...
	runTestCases(t, "TestBracketNotation_WildcardNestedAccess", tests)
}
...
func TestBracketNotation_WildcardNestedErrors(t *testing.T) {
	...
	runTestCases(t, "TestBracketNotation_WildcardNestedErrors", tests)
}
...
func TestBracketNotation_WildcardDeepNestedErrors(t *testing.T) {
	...
	runTestCases(t, "TestBracketNotation_WildcardDeepNestedErrors", tests)
}
