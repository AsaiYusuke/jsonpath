...
func TestSlice_PositiveStepOperations(t *testing.T) {
	...
	for i, testCase := range testCases {
		runTestCase(t, testCase, fmt.Sprintf("TestSlice_PositiveStepOperations[%d]", i))
	}
}
...
func TestSlice_ZeroStepErrorCases(t *testing.T) {
	...
	for i, testCase := range testCases {
		runTestCase(t, testCase, fmt.Sprintf("TestSlice_ZeroStepErrorCases[%d]", i))
	}
}
...
func TestSlice_NegativeStepOperations(t *testing.T) {
	...
	for i, testCase := range testCases {
		runTestCase(t, testCase, fmt.Sprintf("TestSlice_NegativeStepOperations[%d]", i))
	}
}
...
func TestSlice_NegativeStepComplexCases(t *testing.T) {
	...
	for i, testCase := range testCases {
		runTestCase(t, testCase, fmt.Sprintf("TestSlice_NegativeStepComplexCases[%d]", i))
	}
}
...
func TestSlice_NegativeStepVariations(t *testing.T) {
	...
	for i, testCase := range testCases {
		runTestCase(t, testCase, fmt.Sprintf("TestSlice_NegativeStepVariations[%d]", i))
	}
}
...
func TestSlice_OmittedParameters(t *testing.T) {
	...
	for i, testCase := range testCases {
		runTestCase(t, testCase, fmt.Sprintf("TestSlice_OmittedParameters[%d]", i))
	}
}
...
func TestSlice_LargeNumbers(t *testing.T) {
	...
	for i, testCase := range testCases {
		runTestCase(t, testCase, fmt.Sprintf("TestSlice_LargeNumbers[%d]", i))
	}
}
...
func TestSlice_SyntaxVariations(t *testing.T) {
	...
	for i, testCase := range testCases {
		runTestCase(t, testCase, fmt.Sprintf("TestSlice_SyntaxVariations[%d]", i))
	}
}
...
func TestSlice_TypeMismatchErrors(t *testing.T) {
	...
	for i, testCase := range testCases {
		runTestCase(t, testCase, fmt.Sprintf("TestSlice_TypeMismatchErrors[%d]", i))
	}
}
...
func TestSlice_ChildAccessErrors(t *testing.T) {
	...
	for i, testCase := range testCases {
		runTestCase(t, testCase, fmt.Sprintf("TestSlice_ChildAccessErrors[%d]", i))
	}
}
