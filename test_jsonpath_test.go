		...
		},
		{
			...
			[][]interface{}{
				...
				},
				{
					...
					`[{"a":"123"},{"a":123}]`,
					``,
					ErrorInvalidSyntax{4, `multi-valued node retrieve into the filter is prohibited`, `@['a','b']==123)]`},
				},
				{
					`$[?(@.*==2)]`,
		...
		},
		{
			...
			[][]interface{}{
				...
				},
				{
					...
					`[{"b":"123"},{"a":"123"}]`,
					``,
					ErrorInvalidSyntax{4, `multi-valued node retrieve into the filter is prohibited`, `@.*=~/123/)]`},
				},
				{
					`$[?(@[0:1]=~/123/)]`,
					`[{"b":["123"]},{"a":["123"]}]`,
					``,
					ErrorInvalidSyntax{4, `multi-valued node retrieve into the filter is prohibited`, `@[0:1]=~/123/)]`},
				},
				{
					`$[?(@[*]=~/123/)]`,
					`[{"b":"123"},{"a":"123"}]`,
