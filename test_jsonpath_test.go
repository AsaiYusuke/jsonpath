	...
	testGroups := []TestGroup{
		{
			...
			[][]interface{}{
				...
				},
				{
					...
					`["length",1,2]`,
					``,
					ErrorTypeUnmatched{`map`, `[]interface {}`, `.length`},
				},
				{
					`$.a-b`,
					`{"a-b":1}`,
				...
				},
				{
					...
					`["a","b",{"2":1}]`,
					``,
					ErrorTypeUnmatched{`map`, `[]interface {}`, `.2`},
				},
				{
					`$.-1`,
					`["a","b",{"2":1}]`,
					``,
					ErrorTypeUnmatched{`map`, `[]interface {}`, `.-1`},
				},
				{
					`$.a.d`,
					`{"a":"b","c":{"d":"e"}}`,
					``,
					ErrorTypeUnmatched{`map/array`, `string`, `.d`},
				},
				{
					`$.a.d`,
					`{"a":123}`,
					``,
					ErrorTypeUnmatched{`map/array`, `float64`, `.d`},
				},
				{
					`$.a.d`,
					`{"a":true}`,
					``,
					ErrorTypeUnmatched{`map/array`, `bool`, `.d`},
				},
				{
					`$.a.d`,
					`{"a":null}`,
					``,
					ErrorTypeUnmatched{`map/array`, `null`, `.d`},
				},
				{
					`$.a`,
					`[1,2]`,
					``,
					ErrorTypeUnmatched{`map`, `[]interface {}`, `.a`},
				},
				{
					`$.a`,
					`[{"a":1}]`,
