	...
	testGroups := []TestGroup{
		{
			...
			[][]interface{}{
				...
				},
				{
					...
					`["length",1,2]`,
					``,
					ErrorTypeUnmatched{`.length`, `map`, `[]interface {}`},
				},
				{
					`$.a-b`,
					`{"a-b":1}`,
				...
				},
				{
					...
					`["a","b",{"2":1}]`,
					``,
					ErrorTypeUnmatched{`.2`, `map`, `[]interface {}`},
				},
				{
					`$.-1`,
					`["a","b",{"2":1}]`,
					``,
					ErrorTypeUnmatched{`.-1`, `map`, `[]interface {}`},
				},
				{
					`$.a.d`,
					`{"a":"b","c":{"d":"e"}}`,
					``,
					ErrorTypeUnmatched{`.d`, `map/array`, `string`},
				},
				{
					`$.a.d`,
					`{"a":123}`,
					``,
					ErrorTypeUnmatched{`.d`, `map/array`, `float64`},
				},
				{
					`$.a.d`,
					`{"a":true}`,
					``,
					ErrorTypeUnmatched{`.d`, `map/array`, `bool`},
				},
				{
					`$.a.d`,
					`{"a":null}`,
					``,
					ErrorTypeUnmatched{`.d`, `map/array`, `null`},
				},
				{
					`$.a`,
					`[1,2]`,
					``,
					ErrorTypeUnmatched{`.a`, `map`, `[]interface {}`},
				},
				{
					`$.a`,
					`[{"a":1}]`,
		...
		},
		{
			...
			[][]interface{}{
				...
				},
				{
					...
					`{"a":1,"b":2}`,
					``,
					ErrorTypeUnmatched{`[0]`, `array`, `map[string]interface {}`},
				},
				{
					`$[0]`,
					`"abc"`,
					``,
					ErrorTypeUnmatched{`[0]`, `array`, `string`},
				},
				{
					`$[0]`,
					`123`,
					``,
					ErrorTypeUnmatched{`[0]`, `array`, `float64`},
				},
				{
					`$[0]`,
					`true`,
					``,
					ErrorTypeUnmatched{`[0]`, `array`, `bool`},
				},
				{
					`$[0]`,
					`null`,
					``,
					ErrorTypeUnmatched{`[0]`, `array`, `null`},
				},
				{
					`$[0]`,
					`{}`,
		...
		},
		{
			...
			[][]interface{}{
				...
				},
				{
					...
					``,
					ErrorTypeUnmatched{`[1:2]`, `array`, `map[string]interface {}`},
				},
				{
					`$[:]`,
					`{"first":1,"second":2,"third":3}`,
		...
		},
		{
			...
			[][]interface{}{
				...
				},
				{
					...
					`{"first":1,"second":2,"third":3}`,
					``,
					ErrorTypeUnmatched{`[2:1:-1]`, `array`, `map[string]interface {}`},
				},
				{
					`$[::-1]`,
					`{"first":1,"second":2,"third":3}`,
					``,
					ErrorTypeUnmatched{`[::-1]`, `array`, `map[string]interface {}`},
				},
			},
		},
		{
