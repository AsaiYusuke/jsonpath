...
#### Note:
The unstated syntaxes found in "JSONPath - XPath for JSON" are implemented with reference to the test cases written in [cburmer's json-path-comparison](github.com/cburgmer/json-path-comparison).
...
- Adopted more of the consensus behavior from the [cburmer's json-path-comparison](github.com/cburgmer/json-path-comparison).
