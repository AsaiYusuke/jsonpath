	...
	_rules = [...]func() bool{
		...
		func() bool {
			position232, tokenIndex232, depth232 := position, tokenIndex, depth
			{
				...
				depth--
				add(rulenodeFilter, position233)
			}
			return true
		l232:
		...
		func() bool {
			position291, tokenIndex291, depth291 := position, tokenIndex, depth
			{
				...
				depth--
				add(rulesquareBracketStart, position292)
			}
			return true
		l291:
		...
		func() bool {
			position293, tokenIndex293, depth293 := position, tokenIndex, depth
			{
				...
				position++
				depth--
				add(rulesquareBracketEnd, position294)
			}
			return true
		l293:
		...
		func() bool {
			position295, tokenIndex295, depth295 := position, tokenIndex, depth
			{
				...
				depth--
				add(rulescriptStart, position296)
			}
			return true
		l295:
		...
		func() bool {
			position299, tokenIndex299, depth299 := position, tokenIndex, depth
			{
				...
				depth--
				add(rulefilterStart, position300)
			}
			return true
		l299:
		...
		func() bool {
			position303, tokenIndex303, depth303 := position, tokenIndex, depth
			{
				...
				depth--
				add(rulesubQueryStart, position304)
			}
			return true
		l303:
		...
		func() bool {
			position305, tokenIndex305, depth305 := position, tokenIndex, depth
			{
				...
				position++
				depth--
				add(rulesubQueryEnd, position306)
			}
			return true
		l305:
