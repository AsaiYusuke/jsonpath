...
// Code generated by /Users/cmargaria/go/bin/peg jsonpath.peg DO NOT EDIT.
...
func (p *pegJSONPathParser) Execute() {
	...
	for _, token := range p.Tokens() {
		...
		case ruleAction28:
			...
			value := p.pop().(bool)
			if value {
				p.pushCompareParameterLiteral(value)
			} else {
				p.pushCompareParameterLiteral(struct{}{})
			}
...
func (p *pegJSONPathParser) Init(options ...func(*pegJSONPathParser) error) error {
	...
	_rules = [...]func() bool{
		...
		/* 35 basicQuery <- <((subQueryStart query subQueryEnd) / (<comparator> Action26) / (<(logicNot? jsonpathFilter)> Action27) / (lBool Action28))> */
		func() bool {
		...
		/* 39 comparator <- <((qParam space (('=' '=' space qParam Action29) / ('!' '=' space qParam Action30))) / (qNumericParam space (('<' '=' space qNumericParam Action31) / ('<' space qNumericParam Action32) / ('>' '=' space qNumericParam Action33) / ('>' space qNumericParam Action34))) / (singleJsonpathFilter space ('=' '~') space '/' <regex> '/' Action35))> */
		func() bool {
			...
			l226:
				add(rulecomparator, position225)
			}
			return true
		l224:
		...
		/* 40 qParam <- <((qLiteral Action36) / singleJsonpathFilter)> */
		func() bool {
		...
		/* 41 qNumericParam <- <((lNumber Action37) / singleJsonpathFilter)> */
		func() bool {
			...
			l242:
				add(ruleqNumericParam, position241)
			}
			return true
		l240:
		...
		/* 43 singleJsonpathFilter <- <(<jsonpathFilter> Action38)> */
		func() bool {
			position250, tokenIndex250 := position, tokenIndex
			{
				...
				add(rulesingleJsonpathFilter, position251)
			}
			return true
		l250:
		...
		/* 44 jsonpathFilter <- <(Action39 jsonpathParameter Action40)> */
		func() bool {
			position253, tokenIndex253 := position, tokenIndex
			{
				...
				add(rulejsonpathFilter, position254)
			}
			return true
		l253:
		...
		/* 45 lNumber <- <(<(('-' / '+')? [0-9] ('-' / '+' / '.' / [0-9] / [a-z] / [A-Z])*)> Action41)> */
		func() bool {
		...
		/* 46 lBool <- <(((('t' 'r' 'u' 'e') / ('T' 'r' 'u' 'e') / ('T' 'R' 'U' 'E')) Action42) / ((('f' 'a' 'l' 's' 'e') / ('F' 'a' 'l' 's' 'e') / ('F' 'A' 'L' 'S' 'E')) Action43))> */
		func() bool {
		...
		/* 48 lNull <- <((('n' 'u' 'l' 'l') / ('N' 'u' 'l' 'l') / ('N' 'U' 'L' 'L')) Action46)> */
		func() bool {
